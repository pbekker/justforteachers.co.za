  ...
  <div class="skin_width">
    <div class="skin_main_left">
	  <div class="skin_main_right">
	    <div class="skin_main">
		  <div class="nb_skin_content">
		    <div runat="server" id="TopPane" class="nb_toppane" visible="false"></div>
		    <div class="clear_float"></div>
			<div class="dnnpanes">
			  <div runat="server" id="TopLeftPane"  class="nb_topleftpane floatl" visible="false" ></div>
			  <div runat="server" id="TopCenterPane"  class="nb_topcenterpane floatl" visible="false" ></div>
			  <div runat="server" id="TopRightPane"  class="nb_toprightpane floatr" visible="false" ></div>
			  <div class="clear_float"></div>
		    </div>
		    <div class="clear_float"></div>
			<div runat="server" id="ContentPane" class="nb_contentpane" visible="false"></div>
		    <div class="clear_float"></div>
		    <div class="dnnpanes">
			  <div runat="server" id="LeftPane" class="nb_leftpane floatl" visible="false"></div>
			  <div runat="server" id="RightPane" class="nb_rightpane floatr" visible="false"></div>
		      <div class="clear_float"></div>
		    </div>
		    <div class="clear_float"></div>
		    <div runat="server" id="ContentPane2" class="nb_contentpane2" visible="false"></div>
		    <div class="clear_float"></div>
		    <div class="dnnpanes">
			  <div runat="server" id="BottomLeftPane"  class="nb_bottomleftpane floatl" visible="false" ></div>
			  <div runat="server" id="BottomCenterPane"  class="nb_bottomcenterpane floatl" visible="false" ></div>
			  <div runat="server" id="BottomRightPane"  class="nb_bottomrightpane floatr" visible="false" ></div>
			  <div class="clear_float"></div>
		    </div>
		    <div class="clear_float"></div>
		    <div runat="server" id="BottomPane"  class="nb_bottompane" visible="false"></div>
		  </div>
		</div>
	  </div>
    </div>
