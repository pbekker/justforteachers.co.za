	  ...
	  <div class="skin_main_right">
	    <div class="skin_main">
		  <div class="skin_content">
	        <div runat="server" id="ContentPane" class="i1_contentpane" visible="false"></div>
	        <div class="clear_float"></div>
            <div class="dnnpanes">
              <div runat="server" id="LeftPane"  class="i1_leftpane floatl" visible="false" ></div>
	          <div runat="server" id="RightPane"  class="i1_rightpane floatr" visible="false" ></div>
	          <div class="clear_float"></div>
	        </div>
            <div class="clear_float"></div>
	        <div runat="server" id="BottomPane"  class="i1_bottompane" visible="false"></div>
	      </div>
		</div>
	  </div>
    </div>
