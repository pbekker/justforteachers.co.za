...
<div class="Container04_style">
  <div class="Container04_top_bg">
    <div class="Container04_top_left">
      <div class="Container04_top_right">
        <div class="Container04_top_light">
          <div class="c_icon Container04_top_height">
            <dnn:ICON runat="server" id="dnnICON" />
	      </div>
          <div class="c_title Container04_top_height">
  ...
  <div class="c_content_style">
    <div id="ContentPane" runat="server" class="Container04_content"></div>
  </div>
  <div class="c_footer">
