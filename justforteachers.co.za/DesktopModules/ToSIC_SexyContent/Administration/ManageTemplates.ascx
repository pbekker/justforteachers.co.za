<%@ Control Language="C#" AutoEventWireup="true" Inherits="ToSIC.Modules.SexyContent.ManageTemplates" Codebehind="ManageTemplates.ascx.cs" %>
...
<asp:Panel runat="server" class="dnnForm dnnSexyContentManageTemplates dnnClear" id="pnlManageTemplates">
    ...
    <fieldset>
        ...
        <ul class="dnnActions dnnClear">
            ...
            <li><asp:HyperLink ID="hlkImportContent" runat="server" CssClass="dnnSecondaryAction" ResourceKey="hlkImportContent"></asp:HyperLink></li>
        </ul>
    </fieldset>
</asp:Panel>
