						...
						<tr>
							...
							<td>
								...
								<asp:RegularExpressionValidator ID="revStaticName" runat="server" 
									...
									Text='<%# ToSic.EAV.Library.EAVContext.AttributeStaticNameRegExNotes %>' 
									ValidationExpression='<%# ToSic.EAV.Library.EAVContext.AttributeStaticNameRegEx %>' SetFocusOnError="True" Display="Dynamic" />
							</td>
						</tr>
						<tr>
							<th>
...
<asp:ObjectDataSource ID="dsrcAttributes" runat="server" SelectMethod="GetAttributes"
	TypeName="ToSic.EAV.Library.EAVContext" OnObjectCreating="dsrcAttributes_ObjectCreating"
