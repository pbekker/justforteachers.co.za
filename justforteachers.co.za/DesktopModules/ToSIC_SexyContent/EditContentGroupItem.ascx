<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditContentGroupItem.ascx.cs" Inherits="ToSIC.Modules.SexyContent.EditContentGroupItem" %>

<h2 id="hSectionHead" class="dnnFormSectionHead" runat="server"><a href="#"><asp:Label runat="server" ID="lblNewOrEditItemHeading"></asp:Label></a></h2>
<fieldset>
