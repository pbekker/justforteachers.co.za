<%@ Control language="vb" Inherits="DotNetNuke.jb_moreinfo_3ct" CodeBehind="jb_moreinfo_3ct.ascx.vb" AutoEventWireup="false" Explicit="True" %>
	...
	<TR>
		<TD vAlign="top" width="90%">
			...
			<TABLE id="tblMoreInfoCol1" border="0" cellSpacing="0" cellPadding="3" width="100%" runat="server">
			        <tr>
					    <td colspan="2">
						    <table id="tblMainSpecPic" border="0" width="100%">
							    <tr>
							         <td  width="20%" align="left" valign="top">
							            <asp:panel id="pnltblMainSpecPic_2" runat="server" Width="100%" Visible="True">
							                <table id="tblMainSpecPic_2" height="100%" cellPadding="5">							                    				                             				                                
				                                <TR id="trCompanyLogo" runat="server" visible="true">
					                                <TD class="Normal" vAlign="top">
					                                    <asp:panel id="pnlCompanyLogo" Visible="True" HorizontalAlign="left" Width="100%" runat="server">
									            ...
									            <TR id="trAddReview" runat="server" align="left" visible="true">	
										            <TD>
											           <asp:LinkButton id="lnkBtnAddReview" Visible="False" runat="server" CssClass="JediCss_Button">Write a review</asp:LinkButton>
										            </TD>
									            </TR>
									             <TR id="trAttachedDoc" runat="server" align="left" visible="true">					                       
					                                 <TD>
						                                <asp:HyperLink id="hpylAttachedDoc" runat="server" CssClass="JediCss_Button" Target="_blank">Download Attachment</asp:HyperLink>
						                                <div style="display:none">
						                                    <asp:label id="lblAttachedDocMessage" Visible="False" runat="server" CssClass="Normal"></asp:label>
							         ...
							         <td  width="80%" align="left" valign="top">
							            <table id="tblMainSpecPic_1" width="100%" height="100%" cellPadding="5" border="0">
							                <TR>
						                        <TD class="JediCss_MoreInfoTitle" colSpan="2" align="left">
							                       <asp:label id="lblMoreInfoTitle" runat="server"></asp:label>
						                        </TD>
					                        </TR>                        						
					                        <TR id="trAverageReview" runat="server">
						                        <TD colSpan="2">
							                        <asp:panel id="pnlAverageReview" Width="100%" HorizontalAlign="left" Visible="False" BorderWidth="0"
											            ...
											            <A href="#REVIEW"><asp:label id="lblBasedOnReview" Visible="False" runat="server" CssClass="Normal"></asp:label></A>
							                        </asp:panel>
							                    </TD>
					                        </TR>							
							                <TR id="trJobTitle" runat="server" visible="true">
						                        <TD class="Normal" vAlign="top" align="left">Job Title:</TD>
					...
					<TR>
						<TD colspan="2">
						    <asp:label id="lbxMessage" Visible="True" runat="server" CssClass="JediCss_MoreInfoTitle">Description:</asp:label><br />
						    <asp:label id="lblMessage" runat="server"></asp:label><br />&nbsp;
					    </TD>
					</TR>
					<TR id="trAddReqList" runat="server" visible="true">
						<TD colspan="2">
						    <asp:label id="lbxDatalistAddReqList" Visible="True" runat="server" CssClass="JediCss_MoreInfoTitle">Requirements:</asp:label><br />
			...
			<!-- Apply Job -->	
			<asp:panel id="pnlEnableApplyJob" Runat="server" Width="100%" CssClass="Normal" visible="true" >
				<br />					
			    <asp:LinkButton Runat="server" ID="lnkApplyJob_classifieds" CssClass="JediCss_Button" Enabled="True" CausesValidation="False">Apply Now</asp:LinkButton>								
		        ...
		        <br /><br />
		        <asp:label id="lblMessage_ApplyJob" runat="server" CssClass="NormalRed"></asp:label>		
			</asp:panel> 	
			<!-- JOP APPLICANT -->
			<asp:panel id="pnlJobApplicant" Runat="server" Width="100%"
		...
		<TD vAlign="top" width="10%">
			<!-- COLUMN 2 -->							
			<asp:panel id="pnlPageOptions" runat="server" HorizontalAlign="Center" Visible="true" Width="100%" CssClass="JediCss_BoxPanel">
				<asp:table id="tblPageOptions" Runat="server" Width="100%" CellSpacing="0" CellPadding="3">
					<asp:TableRow>
						<asp:TableCell cssclass="JediCss_MoreInfoTitle" ColumnSpan="3" HorizontalAlign="Left">
										Page Options
									</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						...
						<asp:TableCell HorizontalAlign="Right">
										<img runat="server" src="~/DesktopModules/PA_JobBoard/images/PageOptions/ico-po-print.gif" 
								alt="Print this page" align="absmiddle" ID="Img1" />
										&nbsp;</asp:TableCell>
						<asp:TableCell CssClass="Normal" HorizontalAlign="Left">
							<asp:HyperLink Runat="server" ID="lnkPrinter_classifieds" CssClass="Normal">Print this page</asp:HyperLink>
						</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						<asp:TableCell></asp:TableCell>
						<asp:TableCell HorizontalAlign="Right"><img runat="server" src="~/DesktopModules/PA_JobBoard/images/PageOptions/ico-po-fav.gif"
								alt="Add to My List" align="absmiddle" ID="Img3" />
										&nbsp;
									</asp:TableCell>
						<asp:TableCell CssClass="Normal" HorizontalAlign="Left">
							<asp:LinkButton Runat="server" ID="lnkFavorites_classifieds" CssClass="Normal" CausesValidation="false">Add to My List</asp:LinkButton>
						</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						<asp:TableCell></asp:TableCell>
						<asp:TableCell HorizontalAlign="Right"><img runat="server" src="~/DesktopModules/PA_JobBoard/images/PageOptions/ico-po-email.gif"
								alt="Email this page" align="absmiddle" ID="Img2" />
										&nbsp;</asp:TableCell>
						<asp:TableCell CssClass="Normal" HorizontalAlign="Left">
							<asp:LinkButton Runat="server" ID="lnkEmail_classifieds" CssClass="Normal" Enabled="True" CausesValidation="false">Email this page</asp:LinkButton>
						</asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						<asp:TableCell></asp:TableCell>
						<asp:TableCell HorizontalAlign="Right"><img runat="server" src="~/DesktopModules/PA_JobBoard/images/PageOptions/ico-po-inquiry.gif"
								alt="Make an Inquiry" align="absmiddle" ID="Img4" />
										&nbsp;</asp:TableCell>
						<asp:TableCell CssClass="Normal" HorizontalAlign="Left">
							<asp:LinkButton Runat="server" ID="lnkMakeInquiry_classifieds" CssClass="Normal" Enabled="True" CausesValidation="false">Make an Inquiry</asp:LinkButton>
						</asp:TableCell>
					</asp:TableRow>
				</asp:table>
			</asp:panel>
			...
			<asp:panel id="pnlEmailFriend" Width="100%" Visible="False" runat="server">
				<TABLE border="0" cellSpacing="1" cellPadding="1" width="100%">
					<TR vAlign="top">						
						<TD class="Normal" align="left">Your E-Mail:<br />
							<asp:TextBox id="txtEMail" cssclass="Normal" runat="server" width="150" maxlength="100" ToolTip="Enter your e-mail address."
					...
					<TR vAlign="top">						
						<TD class="Normal" align="left">Recipient's E-Mail:<br />
							<asp:TextBox id="txtFriend" cssclass="Normal" Width="150" runat="server" MaxLength="100" ToolTip="Enter your friend's E-Mail address."
								Columns="40"></asp:TextBox>
							<asp:requiredfieldvalidator id="val_req_txtFriend" runat="server" CssClass="NormalRed" Display="Dynamic" ErrorMessage="*"
								ControlToValidate="txtFriend" Enabled="false"></asp:requiredfieldvalidator>
					...
					<TR>						
						<TD class="Normal" align="left">Your Name:<br />
							<asp:TextBox id="txtName" cssclass="Normal" runat="server" width="150" maxlength="100" ToolTip="Enter your name."
								columns="40"></asp:TextBox>
					...
					<TR vAlign="top">						
						<TD class="Normal" align="left">Subject:<br />
							<asp:TextBox id="txtSubject" cssclass="Normal" runat="server" width="150" maxlength="100" ToolTip="Enter subject."
								columns="40"></asp:TextBox>
							<asp:requiredfieldvalidator id="val_req_txtSubject" runat="server" CssClass="NormalRed" Display="Dynamic" ErrorMessage="*"
								ControlToValidate="txtSubject" Enabled="false"></asp:requiredfieldvalidator></TD>
					</TR>
					<TR vAlign="top">						
						<TD class="Normal" align="left">Add a personal note:<br />
							<asp:TextBox id="txtBody" cssclass="Normal" runat="server" Height="67px" TextMode="Multiline"
								width="150" ToolTip="Enter your message." columns="59" Rows="15"></asp:TextBox><BR>
			...
			<asp:label id="lblMessage_PageOptions" runat="server" CssClass="NormalRed"></asp:label><br />
			<asp:Panel ID="pnlAnonymousEdit" runat="server" HorizontalAlign="Center" Visible="true" Width="100%" CssClass="JediCss_BoxPanel">
            ...
            <asp:panel id="pnlEdit" runat="server" CssClass="JediCss_BoxPanel" Visible="true"
