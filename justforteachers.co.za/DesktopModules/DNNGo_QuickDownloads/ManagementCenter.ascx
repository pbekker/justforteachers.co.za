<%@ Control Language="C#" AutoEventWireup="True"
    Inherits="DNNGo.Modules.QuickDownloads.ManagementCenter" Codebehind="ManagementCenter.ascx.cs" %>
    ...
    <div id="mo_info">
        <span class="back">
            <asp:LinkButton ID="lbBack" runat="server" OnClick="lbBack_Click">
                <asp:Label ID="lblBack" runat="server" Text="Back"></asp:Label></asp:LinkButton></span>
        <ul class="help_link">
            <li class="buyit"><a target="_blank" href="http://www.dnngo.net/DNNStore/tabid/58/ProductID/400/Default.aspx">
                <asp:Label ID="lblBuyIt" runat="server">Buy It</asp:Label></a></li>
            <li class="document"><a target="_blank" href="http://www.dnngo.net/FreeDownloads/tabid/184/token/ViewInfo/ItemId/73/Default.aspx">
