<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_DashBoardCenter.ascx.cs" Inherits="DNNGo.Modules.QuickDownloads.Setting_DashBoardCenter" %>
...
<div id="mo_wrapper">
    ...
    <div id="mo_info">
        ...
        <ul class="help_link">
            <li class="buyit"><a target="_blank" href="http://www.dnngo.net/DNNStore/tabid/58/ProductID/498/Default.aspx">
                <asp:Label ID="lblBuyIt" runat="server">Buy It</asp:Label></a></li>
            <li class="document"><a target="_blank" href="http://www.dnngo.net/FreeDownloads/tabid/184/token/ViewInfo/ItemId/202/Default.aspx">
    ...
    <div class="mo_breadcrumb clearfix">
      <div class="EffectName"> <asp:Label ID="lblEffectName"  runat="server" ></asp:Label>
...
<script type="text/javascript">
    jQuery(function (q) {
        ...
        q("h3[class='hndle']").each(function (i, n) {
            q(this).click(function () { q(this).parent().find("div[class='inside']").slideToggle(150); });
        });
