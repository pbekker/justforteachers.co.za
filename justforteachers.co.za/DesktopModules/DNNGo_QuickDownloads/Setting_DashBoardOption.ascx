<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_DashBoardOption.ascx.cs" Inherits="DNNGo.Modules.QuickDownloads.Setting_DashBoardOption" %>
<div class="options_views">
    ...
    <div class="choose_tags form_field handlediv">
        ...
        <div class="inside">
            ...
            <div class="form_field">
                <asp:Image runat="server" style="max-height:300px;" ID="imgThemeThumbnails" Visible="false" />
   ...
   <div class="choose_tags form_field handlediv">
        <h3 class="hndle">
            <%=ViewTitle("lblDataListSetting", "DataList Settings")%></h3>
        <div class="inside">
