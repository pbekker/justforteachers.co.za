<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setting_Effects.ascx.cs" Inherits="DNNGo.Modules.QuickDownloads.Setting_Effects" %>
    ...
    <tr>
        <td>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td rowspan="3" style=" width:350px;  padding:0px 10px 0px 0px; background:none; border:none;">
                                         <asp:Image runat="server" style="max-width:350px;max-height:350px; " ID="imgPicture" />
                                    </td>
            ...
            <div class="full_version_title" id="full_version_title" runat="server" visible="false">
                 ...
                 <%=ViewTitle("lblFullVersionContent", "If you need more effects,Please purchase the <a href='http://www.dnngo.net/DNNStore/tabid/58/CategoryID/105/List/0/Level/a/ProductID/468/Default.aspx' target='_blank'>DNNGo.QuickDownloads</a> to own all amazing effects!")%>
             </div>
        </td>
    </tr>
    <tr>
