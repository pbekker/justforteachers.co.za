// GoogleDriveSettings.ascx

var isFormVisible;
var isInfoVisible;

function setupEvotivaGoogleDriveSettings() {
    $('#evotivaGoogleDriveSettings').dnnPanels();
    evoHideGoogleDriveInfo();
}


function evoHideGoogleDriveInfo() {
    isInfoVisible = true;
    evoShowGoogleDriveInfo();
}

function evoShowGoogleDriveInfo() {
    if (isInfoVisible) {
        $('#evotivaGoogleDriveInfo').hide();
    } else {
        $('#evotivaGoogleDriveInfo').show();
    }
...
$(document).ready(function() {
    setupEvotivaGoogleDriveSettings();
