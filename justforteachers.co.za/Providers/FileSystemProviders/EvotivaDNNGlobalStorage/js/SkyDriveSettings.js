// SkyDriveSettings.ascx

var isFormVisible;
var isInfoVisible;

function setupEvotivaSkyDriveSettings() {
    $('#evotivaSkyDriveSettings').dnnPanels();
    evoHideSkyDriveInfo();
}


function evoHideSkyDriveInfo() {
    isInfoVisible = true;
    evoShowSkyDriveInfo();
}

function evoShowSkyDriveInfo() {
    if (isInfoVisible) {
        $('#evotivaSkyDriveInfo').hide();
    } else {
        $('#evotivaSkyDriveInfo').show();
    }
